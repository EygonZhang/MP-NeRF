...
## Some Notes
### GPU Memory
We train our model on an RTX3090 GPU with 24GB GPU memory. If you have less memory, set N_rand to a smaller value or use multiple GPUs.
### Multiple GPUs
